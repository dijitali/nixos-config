# Kernel exploit-mitigation settings shared by every host (desktop and
# server alike). Boot-loader and boot-cosmetics live in boot.nix, which only
# the graphical machines import.
{
  boot = {
    # Memory-hardening allocator options. Small runtime cost but real
